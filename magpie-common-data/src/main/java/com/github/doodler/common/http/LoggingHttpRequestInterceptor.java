...
public class LoggingHttpRequestInterceptor implements ClientHttpRequestInterceptor, Ordered {
    ...
    public ClientHttpResponse intercept(HttpRequest request, byte[] body,
        ...
        try {
            ...
            String responseBodyString = isHtmlResponseMediaType(mediaType) || isRestfulResponseMediaType(mediaType) ?
            ...
            if (log.isTraceEnabled()) {
                log.trace(Markers.SYSTEM, str.toString());
            }
        }
        return response;
    }
    ...
    private boolean isRestfulResponseMediaType(MediaType mediaType) {
        return MediaType.APPLICATION_JSON.equals(mediaType) || MediaType.APPLICATION_JSON_UTF8.equals(mediaType) ||
                MediaType.APPLICATION_XML.equals(mediaType) || MediaType.APPLICATION_GRAPHQL.equals(mediaType);
    }
    ...
    private String trimResponseBodyString(String responseBodyString) {
        ...
        return responseBodyString.substring(0, maxLengthOfResponseBodyString).concat(" Omitted ...");
    }
