...
public class RpcProxyObject<API> implements InvocationHandler, RetryListener {
    ...
    private final ObjectProvider<RpcInterceptor> interceptors;
    private final ApplicationContext applicationContext;


    RpcProxyObject(Class<API> interfaceClass, RpcTemplate rpcTemplate,
            RetryOperations retryOperations, ObjectProvider<RpcInterceptor> interceptors,
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        interceptors.forEach(i -> i.beforeInvocation(actualInstance, method, args));
        try {
            ...
            final Throwable ref = cause;
            interceptors.forEach(i -> i.afterInvocation(actualInstance, method, args, ref));
        }
    }
